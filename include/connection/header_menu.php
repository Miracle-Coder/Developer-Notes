...
<div class="leb-checkbox">
    <label class="menu-label" for="menu-checkbox"><img src="/images/menu-icon.png" alt=""></label>
</div>
...
<ul id="menu">
    ...
    <li><a href="http://developer-notes.h1n.ru/include/pages/About_Blog.php">About Blog</a>
        <ul>
            ...
            <li><a href="http://developer-notes.h1n.ru/include/pages/Why_Register_Here.php">Why Register Here</a></li>
        </ul>
    </li>
