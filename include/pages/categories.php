        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    $total_count = R::count('articles', 'categories_id = ?', [(int)$_GET['id']]);
                    ...
                    $articles_categories_page = R::findLike('articles', array(
                            'categories_id' => array($_GET['id'])
                    ), "ORDER BY `views` DESC LIMIT 5");

                    if ($articles_categories_page)

                    {
                        foreach( $articles_categories_page as $item )
                        {
                            ?>
                    ...
                    if ($page > 1)
                    {
                        ...
                        echo '<span class="mas">Предыдущая </span>';
                        echo '<button id="work" type="button" name="Hover" onclick="window.location.href=\'http://developer-notes.h1n.ru/index.php?page='.($page - 1).'\'"> Предыдущая';
                        echo '</button>';
                        echo '</div>';
                    ...
                    if ($page < $total_page)
                    {
                        ...
                        echo '<span class="mas">Следующая </span>';
                        echo '<button id="work" type="button" name="Hover" onclick="window.location.href=\'http://developer-notes.h1n.ru/index.php?page='.($page + 1).'\'"> Следующая';
                        echo '</button>';
                        echo '</div>';
                    }
                    echo '</div>';
