...
$(function() {
    ...
    */
    ...
    var allComments = [
        {userid: '1', name: 'Tester 1', avatar: 'default', before: '5 minutes before', message: 'That is cool!'},
        {userid: '2', name: 'Chuck Norris', avatar: 'https://i.imgur.com/Nl7oXdq.png', before: '15 minutes before', message: 'I can totally say, that is not good as me, but whatever.'},
        {userid: '3', name: 'Demo', avatar: 'default', before: '30 minutes before', message: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin condimentum non justo ut accumsan. Pellentesque hendrerit vitae urna at faucibus.'}
    ];
    var loaded = 0;
